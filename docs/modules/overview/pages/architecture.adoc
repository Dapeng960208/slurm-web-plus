...
versions from *v{api_version}* to *v{api_version_latest}*. These versions of
Slurm REST API are available in Slurm major versions 23.11, 24.05, 24.11,
25.05 and 25.11.
