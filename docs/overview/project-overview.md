...
- 集群级 `Admin` 页面统一管理 AI、Cache、LDAP Cache 与 Access Control；AI 管理页同时提供所有用户会话审计
...
- `/settings/ai`、`/settings/access-control`、`/settings/cache`、`/settings/ldap-cache` 只是兼容重定向入口
