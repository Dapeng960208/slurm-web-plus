...
class SlurmwebAppGateway(SlurmwebWebApp, RFLTokenizedWebApp):
    ...
    VIEWS = {
        ...
        SlurmwebAppRoute("/api/agents/<cluster>/analysis/context", views.analysis_context),
        ...
        SlurmwebAppRoute(
            "/api/agents/<cluster>/jobs/submit",
            views.job_submit,
            methods=["POST"],
        ),
        SlurmwebAppRoute(
            "/api/agents/<cluster>/job/<int:job>/update",
            views.job_update,
            methods=["POST"],
        ),
        SlurmwebAppRoute(
            "/api/agents/<cluster>/job/<int:job>/cancel",
            views.job_cancel,
            methods=["DELETE"],
        ),
        ...
        SlurmwebAppRoute(
            "/api/agents/<cluster>/node/<name>/update",
            views.node_update,
            methods=["POST"],
        ),
        SlurmwebAppRoute(
            "/api/agents/<cluster>/node/<name>/delete",
            views.node_delete,
            methods=["DELETE"],
        ),
        ...
        SlurmwebAppRoute(
            "/api/agents/<cluster>/qos",
            views.qos_update,
            methods=["POST"],
        ),
        SlurmwebAppRoute(
            "/api/agents/<cluster>/qos/<name>/delete",
            views.qos_delete,
            methods=["DELETE"],
        ),
        SlurmwebAppRoute("/api/agents/<cluster>/reservations", views.reservations),
        SlurmwebAppRoute(
            "/api/agents/<cluster>/reservation",
            views.reservation_create,
            methods=["POST"],
        ),
        SlurmwebAppRoute(
            "/api/agents/<cluster>/reservation/<name>/update",
            views.reservation_update,
            methods=["POST"],
        ),
        SlurmwebAppRoute(
            "/api/agents/<cluster>/reservation/<name>/delete",
            views.reservation_delete,
            methods=["DELETE"],
        ),
        SlurmwebAppRoute("/api/agents/<cluster>/accounts", views.accounts),
        SlurmwebAppRoute(
            "/api/agents/<cluster>/accounts",
            views.accounts_update,
            methods=["POST"],
        ),
        SlurmwebAppRoute("/api/agents/<cluster>/account/<name>", views.account),
        SlurmwebAppRoute(
            "/api/agents/<cluster>/account/<name>/delete",
            views.account_delete,
            methods=["DELETE"],
        ),
        SlurmwebAppRoute("/api/agents/<cluster>/associations", views.associations),
        SlurmwebAppRoute(
            "/api/agents/<cluster>/associations",
        ...
        SlurmwebAppRoute("/api/agents/<cluster>/users", views.users_admin),
        SlurmwebAppRoute(
            "/api/agents/<cluster>/users",
            views.users_update,
            methods=["POST"],
        ),
        SlurmwebAppRoute("/api/agents/<cluster>/user/<name>", views.user_admin),
        SlurmwebAppRoute(
