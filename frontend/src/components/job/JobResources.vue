    ...
    <ul class="space-y-2.5">
      <li>
        <span class="inline-flex items-center gap-2"
          ...
          ><span>{{ t('common.labels.nodes') }}: {{ resources.node }}</span></span
        >
      </li>
      <li>
        <span class="inline-flex items-center gap-2"
          ...
          ><span>{{ t('common.labels.cpu') }}: {{ resources.cpu }}</span></span
        >
      </li>
      <li>
        <span class="inline-flex items-center gap-2"
          ...
          ><span>{{ t('common.labels.memory') }}: {{ getMBHumanUnit(resources.memory) }}</span></span
        >
      </li>
      <li v-if="gpu.count > 0">
        <span class="inline-flex items-center gap-2"
